...
export const PlayerSelector = ({changeRole, selectedRole}: CommonProps<PlayerSelectorProps>) => (
	<Container>
		<LaneContainer>
			<Selector>
				<Button onClick={() => changeRole("TOP")} className={selectedRole === "TOP" ? "selected" : ""}>
			...
			<Selector>
				<Button onClick={() => changeRole("JUNGLE")} className={selectedRole === "JUNGLE" ? "selected" : ""}>
			...
			<Selector>
				<Button onClick={() => changeRole("MIDDLE")} className={selectedRole === "MIDDLE" ? "selected" : ""}>
			...
			<Selector>
				<Button onClick={() => changeRole("BOTTOM")} className={selectedRole === "BOTTOM" ? "selected" : ""}>
			...
			<Selector>
				<Button onClick={() => changeRole("UTILITY")} className={selectedRole === "UTILITY" ? "selected" : ""}>
		...
		<Selector>
			<Button onClick={() => changeRole("ANY")} className={selectedRole === "ANY" ? "selected" : ""}>
